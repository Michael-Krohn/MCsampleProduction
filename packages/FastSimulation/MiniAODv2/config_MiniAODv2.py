...
import sys
import argparse
sys.path.append("../../../../packages/setups/Fast/")
...
#  os.system("sed -i 's|###UNITSPERJOB###|"+str(int(nevents)/int(nsplitjobs))+"|g' "+datasetname+"/submit_crab.py")
  ...
  cmsdriver_l = "cmsDriver.py step1 --no_exec --mc --python_filename run_crab.py --fileout "+step+".root --eventcontent MINIAODSIM --fast --runUnscheduled --datatier MINIAODSIM --geometry DB:Extended --step PAT --procModifiers run2_miniAOD_UL -n 6284 "+add_cmsdriver 
